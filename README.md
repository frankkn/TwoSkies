...
Each sky shows live conditions (rendered as slow, quiet animation — drifting clouds, falling rain, twinkling stars, sun and moon by that city's own daylight), current temperature with today's high/low, a 24-hour hourly strip, and a 10-day forecast with iPhone-style temperature range bars — all on a frosted glass card, all in **that place's local clock**. Their 8 PM is your view of their evening.
